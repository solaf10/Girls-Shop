          ...
          <div className="bring-idea-container">
            <div className="Bring-idea-tolife-sec">
              ...
              <p className="bring-your-idea-paragraph">
                Create a custom design form tailored to your needs. Easily
                personalize fields, layout, and style to match your brand or
                project requirements.
              </p>
            </div>
            <form onSubmit={privateRouteHandler} className="customize-form">
              ...
              <div className="color-counter-box">
                ...
                <div className="choose-color">
                  ...
                  <input type="color" defaultValue="#385854" />
                </div>
              </div>
